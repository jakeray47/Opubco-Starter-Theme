...
class CMB_Text_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input type="text" placeholder="<?php echo $this->args['placeholder'];?>" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr(); ?> <?php $this->name_attr(); ?> value="<?php echo esc_attr( $this->get_value() ); ?>" />
...
class CMB_Textarea_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<textarea placeholder="<?php echo $this->args['placeholder'];?>" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr(); ?> rows="<?php echo ! empty( $this->args['rows'] ) ? esc_attr( $this->args['rows'] ) : 4; ?>" <?php $this->name_attr(); ?>><?php echo esc_html( $this->value ); ?></textarea>
