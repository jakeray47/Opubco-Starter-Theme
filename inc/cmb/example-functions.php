 ...
 * @return array
 */
function post_type_labels( array $meta_boxes ) {

	// Example of all available fields
	
	$fields = array(

		array( 'id' => 'post_type_labels', 'name' => 'Labels', 'type' => 'title'),
...
add_filter( 'cmb_meta_boxes', 'post_type_labels' );
