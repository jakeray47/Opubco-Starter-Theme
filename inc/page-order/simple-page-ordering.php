...
class Simple_Page_Ordering {
	...
	public static function wp() {
		if ( 0 === strpos( get_query_var('orderby'), 'menu_order' ) ) {
			...
			wp_enqueue_script( 'simple-page-ordering', get_template_directory_uri(). '/inc/page-order/'.$script_name, array('jquery-ui-sortable'), '2.1', true );
			wp_enqueue_style( 'simple-page-ordering', get_template_directory_uri(). '/inc/page-order/simple-page-ordering.css');
		}
	}
